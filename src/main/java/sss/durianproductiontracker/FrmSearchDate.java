 ...
 * @author USER
 */
public class FrmSearchDate extends javax.swing.JFrame {

    /**
     * Creates new form FrmSearchDate
     */
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        FrmDisplayByDate frmDBD = new FrmDisplayByDate(Integer.parseInt(this.jTextFieldYear.getText()), Integer.parseInt(this.jTextFieldMonth.getText()), Integer.parseInt(this.jTextFieldDay.getText()));
        frmDBD.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSearchDate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmSearchDate().setVisible(true);
            }
        });
    }
