 ...
 * @author USER
 */
public class FrmSeaerchDate2 extends javax.swing.JFrame {

    /**
     * Creates new form FrmSeaerchDate2
     */
    public FrmSeaerchDate2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextFieldMonth.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jTextFieldMonth.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextFieldMonth.setName(""); // NOI18N
        ...
        jTextFieldDay.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        jTextFieldYear.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        ...
        jLabel10.setText("date to start:");

        jLabel11.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel11.setText("number of days to search:");

        jTextFieldCount.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jTextFieldCount.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextFieldCount.setName(""); // NOI18N
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jTextFieldYear, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                            ...
                            .addComponent(jTextFieldCount, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7)
                    .addComponent(jLabel8)
                    .addComponent(jTextFieldYear, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel9)
                    .addComponent(jTextFieldMonth, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jTextFieldDay, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addComponent(jLabel11)
                .addGap(18, 18, 18)
                .addComponent(jTextFieldCount, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        frmDisplayDateFromTo frmDDFT = new frmDisplayDateFromTo(Integer.parseInt(this.jTextFieldYear.getText()), Integer.parseInt(this.jTextFieldMonth.getText()), Integer.parseInt(this.jTextFieldDay.getText()), Integer.parseInt(this.jTextFieldCount.getText()));
        frmDDFT.setVisible(true);
        this.dispose();
    ...
    private void jTextFieldMonthKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldMonthKeyTyped
        ...
        if(jTextFieldMonth.getText().length()>=2){
            evt.consume();
        }
    ...
    private void jTextFieldDayKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDayKeyTyped
        // TODO add your handling code here:
        char c = evt.getKeyChar();
        if(!Character.isDigit(c)){
            evt.consume();
        }
        if(jTextFieldDay.getText().length()>=2){
            evt.consume();
        }
    }//GEN-LAST:event_jTextFieldDayKeyTyped
    ...
    private void jTextFieldYearKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldYearKeyTyped
        ...
        if(jTextFieldYear.getText().length()>=4){
            evt.consume();
        }
    ...
    private void jTextFieldCountKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldCountKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldCountKeyTyped
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSeaerchDate2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmSeaerchDate2().setVisible(true);
            }
        });
    }
