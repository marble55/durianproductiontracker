...
public class FrmDisplayOpenedBatches extends javax.swing.JFrame {

    /**
     * Creates new form FrmDisplayOpenedBatches
     */
    public FrmDisplayOpenedBatches() {
        initComponents();
        populateTable();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Opened Batches");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDisplayOpenedBatches.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmDisplayOpenedBatches().setVisible(true);
            }
        });
    }
