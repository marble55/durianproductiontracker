 ...
 * @author USER
 */
public class FrmFindPBatch extends javax.swing.JFrame {

    /**
     * Creates new form FrmFindPBatch
     */
    public FrmFindPBatch() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Date Packaged:");
        ...
        jLabel1.setText("Find Packaged Batch");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        DurianPackaging x = new DurianPackaging (this.jTextField2.getText(), this.jTextField3.getText(), this.jTextField4.getText(), date, date2, date3);

        DurianPackaging y = packagingController.PList.retrieveDurianPackaging(x);

        if(y != null){
            
                packagingController.PList.deleteDurianPackaging(y);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmFindPBatch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmFindPBatch().setVisible(true);
            }
        });
    }
